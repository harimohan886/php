...
<html lang="en">
    <head>
        ...
        <title><?php echo PROJECT_NAME; ?> | Dealer  Login </title>
        <!--favicon-->
        <link rel="icon" href="<?php echo base_url(); ?>assets/images/sticker.png" type="image/x-icon">
        <!-- Bootstrap core CSS-->
    ...
    <body style="background-image:url('http://localhost/ooorm/assets/images/loginbg.jpg');background-size:cover;">
        <!-- start loader -->
            ...
            <div class="card card-authentication1 mx-auto my-5">
                <div class="card-body">
                    <div class="card-content p-2">
                        ...
                        <div class="card-title text-uppercase text-center py-3">Dealers Sign In</div>
                        ...
                        <form class="md-float-material form-material" name="loginform" id="loginform" method="post"  enctype="multipart/form-data">
                            ...
                            <button type="button" class="btn btn-primary btn-block" id="btnContactUs">Sign In</button>
                        </form>
                    </div>
                </div>
                <div class="card-footer text-center py-3">
                    <p class="text-dark mb-0">Do not have an account? <a href="<?php echo base_url(); ?>admin/forgot_password"> Forgot Password</a></p>
                </div>
            </div>
