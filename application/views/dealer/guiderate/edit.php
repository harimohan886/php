                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="language_id">
                                                    ...
                                                    <?php foreach ($language as $row) { ?>
                                                        <option value="<?php echo $row->id; ?>" <?php if ($row->id == $rate_data->language_id) {
                                                        echo "selected";
...
<?php } ?>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="country_id">
                                                    ...
                                                    <?php foreach ($country as $row) { ?>
                                                        <option value="<?php echo $row->id; ?>" <?php if ($row->id == $rate_data->country_id) {
                                                        echo "selected";
                                                    } ?>><?php echo $row->name; ?>
                                                        </option>
                                                    <?php } ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" id="currency" name="currency"
                                                       placeholder="Currency" value="<?php echo $rate_data->currency; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" id="rate" name="rate"
                                                       placeholder="Rate" value="<?php echo $rate_data->price; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="checkbox" id="indeterminate-checkbox" name="status" class="js-switch" <?php if ($rate_data->status == '1') { echo "checked"; } ?> />
                                            </div>
                                        </div>
                                        <div class="form-group py-2 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" class="btn btn-info" id="save_buttons"
                                                       name="save_button" value="Update">
                                                <button type="submit" class="btn btn-primary px-5" id="save_button"
                                                        name="save_button" value="Update">Update</button>
