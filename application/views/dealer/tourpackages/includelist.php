                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?php echo site_url("tour_dealer/tour_include_add"); ?>" class="btn btn-info waves-effect waves-light m-1 pull-right" style="color: rgb(255, 255, 255); padding: 5px 13px;"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (count($tour_include) > 0) {
                                                        ...
                                                        foreach ($tour_include as $category) {
                                                            $edit = base_url() . 'tour_dealer/tour_include_edit/' . $category->id;
                                                            $delete = ADMIN_URL . 'tour_dealer/tour_include_delete/' . $category->id;
                                                            ?>  
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
                                                                ...
                                                                <td>
                                                                    <input type="checkbox" class="js-switch tgl_checkbox"  data-table="tbl_tour_include" data-status="status" data-idfield="id"  data-id="<?php echo $category->id; ?>" id='cb_<?php echo $category->id; ?>'  <?php echo ($category->status == '1') ? "checked" : ""; ?> />
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo $edit; ?>" data-toggle="tooltip"  data-placement="left" title="Edit" class="btn btn-warning waves-effect waves-light m-1"><i class="fa fa-clock-o" aria-hidden="true"></i></a>
