                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="language_id">
                                                    ...
                                                    <?php foreach ($language as $row) { ?>
                                                        <option value="<?php echo $row->id; ?>" <?php if ($row->id == $includedata->language_id) {
                                                        echo "selected";
...
<?php } ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="input-22" class="col-sm-2 col-form-label">Include Add</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" id="name" name="name" placeholder="include name" value="<?php echo $includedata->name; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="checkbox" id="indeterminate-checkbox" name="status" class="js-switch" <?php if ($includedata->status == '1') {
    echo "checked";
} ?> />
                                            </div>
                                        </div>
