                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="<?php echo trim($include->name); ?>" name="included[]" value="<?php echo $include->id; ?>" <?php if (in_array($include->id, $explode)) {
            echo "checked";        } ?>>
