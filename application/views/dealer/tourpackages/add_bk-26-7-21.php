                    ...
                    $(function () {
                        ...
                        $("#form").validate({
                            ...
                            messages: {
                                ...
                                "placeimage[]": {required: "Please Enter Place Image", },
                            },
                    ...
                    function calculate(d1, d2) {
                        ...
                        if (d1 && d2) {
                            ...
                            for (var i = 1; i <= a; i++) {
                                ...
                                data +=
                                        '<input class="form-control" type="text" id="placename" name="placename[]" placeholder="Place Name">';
                                data += '</div>';
                                data += '</div>';
                                data += '<div class="form-group row">';
                                ...
                                data += '<div class="col-sm-8">';
                                data +=
                                        '<textarea class="form-control" id="placedesc" name="placedesc[]" placeholder="Place Description"></textarea>';
                                data += '</div>';
                                data += '</div>';
                                data += '<div class="form-group row">';
