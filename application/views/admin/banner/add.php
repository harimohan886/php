         ...
         <div class="card">
          ...
          <form class="form" name="form" id="form" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" name="tag" id="tag" class="form-control" placeholder="Plz Enter Tag">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" name="url" id="url" class="form-control" placeholder="Please Enter Url">
                </div>
            </div>
