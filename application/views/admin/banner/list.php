          ...
          <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="<?php echo site_url("banner/banner_add"); ?>" class="btn btn-info waves-effect waves-light m-1 pull-right" style="color: rgb(255, 255, 255); padding: 5px 13px;"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <?php
                            if (count($banner) > 0) {
                                ...
                                foreach ($banner as $category) {
                                    $edit_url = ADMIN_URL . 'banner/banner_edit/' . $category->id;
                                    $delete_url = ADMIN_URL . 'banner/banner_delete/' . $category->id;
                                    ?>  
                                    <tr>
