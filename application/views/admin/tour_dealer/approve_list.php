                                            ...
                                            <?php
                                                if (count($approve_records) > 0) {
                                                    ...
                                                    foreach ($approve_records as $category) {
                                                        $pending = ADMIN_URL . 'tour_dealer/tour_dealer_pending/' . $category->id;
                                                        $reject = ADMIN_URL . 'tour_dealer/tour_dealer_reject/' . $category->id;

                                                        $booking = ADMIN_URL . 'tour_dealer/tour_dealer_booked_list/' . $category->id;
                                                    ?>  
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            ...
                                                            <td><?php
                                                                    ...
                                                                    echo $date . " " . $time; ?></td>
                                                            <td><a href="<?php echo $pending; ?>" data-toggle="tooltip"  data-placement="left" title="Pending" class="btn btn-warning waves-effect waves-light m-1"><i class="fa fa-clock-o" aria-hidden="true"></i></a>
                                                                ...
                                                                <a href="<?php echo $booking; ?>"><i class="fa fa-eye" aria-hidden="true"></i> Booking</a></td>
                                                            </tr>
                                                    <?php $i = $i + 1;
                                                    }
                                                } ?>
