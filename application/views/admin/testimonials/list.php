...
<div class="clearfix"></div>
    ...
    <div class="content-wrapper">
        ...
        <div class="col-sm-9">
            <h4 class="page-title"><?php echo $page; ?> List</h4>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
                <h4><?php echo $page; ?> List</h4>
                <span></span>
                <div class="pull-right">
                    <a href="<?php echo site_url("testimonials/testimonials_add"); ?>" class="btn btn-info waves-effect waves-light m-1 pull-right" style="color: rgb(255, 255, 255); padding: 5px 13px;"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            if (count($testimonials) > 0) {
                                $returnpath = $this->config->item('testimonials_images_uploaded_path');
                                foreach ($testimonials as $category) {
                                    $edit_url = ADMIN_URL . 'testimonials/testimonials_edit/' . $category->id;
                                    $delete_url = ADMIN_URL . 'testimonials/testimonials_delete/' . $category->id;
                                    ?>  
                                    <tr>
                                        <td><?php echo $category->id; ?></td>
                                        <td><img src="<?php echo $returnpath.$category->image; ?>" class="round" alt="image" height="50px" width="50px"></td>
