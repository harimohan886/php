            ...
            <div class="card-body">
                ...
                ?>
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php
                            if (count($pending_records) > 0) {
                                $i = 1;
                                foreach ($pending_records as $category) {

                                    $approve = ADMIN_URL . 'corporate_event_dealer/corporate_event_dealer_approve/' . $category->id;
                                    $reject = ADMIN_URL . 'corporate_event_dealer/corporate_event_dealer_reject/' . $category->id;
                                    ?>  
                                    <tr>
                                        <td><?php echo $i; ?></td>
