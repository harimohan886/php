                                ...
                                <form class="form" name="form" id="form_edit" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class="form-control" type="text" name="name" id="name" value="<?php echo $social->name;?>">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Link<span class="text-danger">*</span></label>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class="form-control" type="url" name="link" id="link" value="<?php echo $social->link;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class="form-control" type="text" name="icon_class" id="icon_class" value="<?php echo $social->icon_class;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Status <span class="text-danger">*</span></label>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                           <input type="checkbox" class="js-switch tgl_checkbox" name="status" <?php if($social->status=='1'){echo "checked";}?>/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
