    ...
    <div class="col-lg-12">
         ...
         <div class="card">
          ...
          <form class="form" name="form" id="form" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="input-22" class="col-sm-2 col-form-label">Quastion</label>
                <div class="col-sm-8">
                <input class="form-control" type="text" id="questions" name="questions" placeholder="Quastion">
                </div>
            </div>

            <div class="form-group row">
                <label for="input-22" class="col-sm-2 col-form-label">Answer</label>
                <div class="col-sm-8">
                 <textarea class="form-control" id="answers" name="answers" placeholder="Answers"></textarea>
                </div>
            </div>
...
<script>
    $(function() {
        ...
        messages: {
            questions: {
                required:"Please Enter Quastion",
            },
            answers: {
