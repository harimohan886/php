                        ...
                        <div class="card wizard-content">
                            <div class="card-body">
                                <?php
                                    ...
                                    ?>
                                 <h4 class="card-title">Add New <?php echo $page; ?></h4>
                                 ...
                                 <form class="form" name="form" id="form_edit" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <select name="languages" id="languages" class="form-control select2">
                                              <option name="" id="" value="">-- Select languages ---</option>

                                              <?php if(count($languages)>0) {
                                               foreach($languages as $k=>$b) {
                                                ?>
                                                <option name="<?php echo $b->id; ?>" id="<?php echo $b->id; ?>" value="<?php echo $b->id; ?>"><?php echo ucwords($b->language); ?></option>
                                             <?php }
                                             } ?>
                                           </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class="form-control" type="text" id="label_key" name="label_key" placeholder="Enter Message Key">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class="form-control" type="text" id="label_value" name="label_value" placeholder="Message value">
                                        </div>
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input class='tgl tgl-ios tgl_checkbox js-switch' name="label_status" id="label_status" type='checkbox' checked="checked" />
                                        </div>
                                    </div>
