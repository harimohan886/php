...
$adminpath=$this->config->item('admin_images_uploaded_path');
?>
...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    ...
    <div class="user-details">
        <div class="media align-items-center user-pointer collapsed" data-toggle="collapse"
            ...
            <div class="avatar"><img class="mr-3 side-user-img" src="<?php echo $adminpath.$userdata['adminimage'];?>"
                    alt="user avatar"></div>
        ...
        <div id="user-dropdown" class="collapse">
            <ul class="user-setting-menu">
                <li><a href="<?php echo base_url(); ?>admin/settings"><i class="icon-user"></i> My Profile</a></li>
                <li><a href="<?php echo base_url(); ?>admin/settings"><i class="icon-settings"></i> Setting</a></li>
                <li><a href="<?php echo base_url(); ?>login/signout"><i class="icon-power"></i> Logout</a></li>
            </ul>
        </div>
    </div>
    <ul class="sidebar-menu">
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>admin/dashboard"><i class="zmdi zmdi-dot-circle-alt"></i>
                        Dashboard</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>language/language_list"><i class="zmdi zmdi-dot-circle-alt"></i>
                        Language list</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>cmspage/pages/1"><i class="zmdi zmdi-dot-circle-alt"></i>  About Us</a></li>
                <li><a href="<?php echo base_url();?>cmspage/pages/2"><i class="zmdi zmdi-dot-circle-alt"></i>Tearms And Condition</a></li>
                <li><a href="<?php echo base_url();?>cmspage/pages/3"><i class="zmdi zmdi-dot-circle-alt"></i>Privacy Policy</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Tour Dealer</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>tour_dealer/tour_dealer_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i> Tour Dealer Approve list</a></li>
                <li><a href="<?php echo base_url();?>tour_dealer/tour_dealer_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i>  Tour Dealer Reject list</a></li>
                <li><a href="<?php echo base_url();?>tour_dealer/tour_dealer_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Tour Dealer Pending list</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Car Dealer</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>car_dealer/car_dealer_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i> Car Dealer Approve list</a></li>
                <li><a href="<?php echo base_url();?>car_dealer/car_dealer_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i> Car Dealer Reject list</a></li>
                <li><a href="<?php echo base_url();?>car_dealer/car_dealer_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Car Dealer Pending list</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Tour Guide</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>tour_guide/tour_guide_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i>  Tour Guide Approve list</a></li>
                <li><a href="<?php echo base_url();?>tour_guide/tour_guide_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i> Tour Guide Reject list</a></li>
                <li><a href="<?php echo base_url();?>tour_guide/tour_guide_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Tour Guide Pending list</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Medical Dealer</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>medical_dealer/medical_dealer_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i>  Medical Dealer Approve list</a></li>
                <li><a href="<?php echo base_url();?>medical_dealer/medical_dealer_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i> Medical Dealer Reject list</a></li>
                <li><a href="<?php echo base_url();?>medical_dealer/medical_dealer_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Medical Dealer Pending list</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Education Dealer</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>education_dealer/education_dealer_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i>  Education Dealer Approve list</a></li>
                <li><a href="<?php echo base_url();?>education_dealer/education_dealer_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i> Education Dealer Reject list</a></li>
                <li><a href="<?php echo base_url();?>education_dealer/education_dealer_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Education Dealer Pending list</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-layers"></i>
                <span>Corporate Event Dealer</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>corporate_event_dealer/corporate_event_dealer_approve_list"><i class="zmdi zmdi-dot-circle-alt"></i>  Corporate Event Approve list</a></li>
                <li><a href="<?php echo base_url();?>corporate_event_dealer/corporate_event_dealer_reject_list"><i class="zmdi zmdi-dot-circle-alt"></i> Corporate Event Reject list</a></li>
                <li><a href="<?php echo base_url();?>corporate_event_dealer/corporate_event_dealer_pending_list"><i class="zmdi zmdi-dot-circle-alt"></i> Corporate Event Pending list</a></li>
            </ul>
        </li>
        <li>
            <a href="javaScript:void();" class="waves-effect">
            ...
            <ul class="sidebar-submenu">
                <li><a href="<?php echo base_url();?>customer/customer_list"><i class="zmdi zmdi-dot-circle-alt"></i>
                        Customer list</a></li>
            </ul>
        </li>
    </ul>
...
<ul class="pcoded-item pcoded-left-item">
    <li class="pcoded-hasmenu <?php if($active=="myschool"){echo "pcoded-trigger";}?>">
        <a href="javascript:void(0)">
            <span class="pcoded-micon"><i class="feather icon-home"></i></span>
            <span class="pcoded-mtext">School</span>
        </a>
        <ul class="pcoded-submenu">
            <li class="<?php if($sub=="school_list") {echo "active";}?>">
                <a href="<?php echo base_url(); ?>myschool/school_list">
                    <span class="pcoded-mtext">School List</span>
                </a>
            </li>
            <li class="<?php if($sub=="parents_school_list") {echo "active";}?>">
                <a href="<?php echo base_url(); ?>myschool/parents_school_list">
                    <span class="pcoded-mtext">Parents List</span>
                </a>
            </li>
        </ul>
    </li>
...
<ul class="pcoded-item pcoded-left-item">
    <li class="pcoded-hasmenu <?php if($active=="plans"){echo "pcoded-trigger";}?>">
        <a href="javascript:void(0)">
            <span class="pcoded-micon"><i class="feather icon-home"></i></span>
            <span class="pcoded-mtext">Subscription Plan</span>
        </a>
        <ul class="pcoded-submenu">
            <li class="<?php if($sub=="plans_list") {echo "active";}?>">
                <a href="<?php echo base_url(); ?>plans/plans_list">
...
<ul class="pcoded-item pcoded-left-item">
    <li class="pcoded-hasmenu <?php if($active=="myschool"){echo "pcoded-trigger";}?>">
        ...
        <ul class="pcoded-submenu">
            <li class="<?php if($sub=="get_standard_list") {echo "active";}?>">
                <a href="<?php echo base_url(); ?>myschool/get_standard_list">
                    <span class="pcoded-mtext">Standard List</span>
                </a>
            </li>
        </ul>
    </li>
...
<ul class="pcoded-item pcoded-left-item">
    <li class="pcoded-hasmenu <?php if($active=="driver"){echo "pcoded-trigger";}?>">
        <a href="javascript:void(0)">
            <span class="pcoded-micon"><i class="feather icon-home"></i></span>
            <span class="pcoded-mtext">Driver</span>
        </a>
        <ul class="pcoded-submenu">
            <li class="<?php if($active=="driver"){ echo "active";} ?>">
                <a href="<?php echo base_url(); ?>driver/driver_list">
...
<ul class="pcoded-item pcoded-left-item">
    <li class="pcoded-hasmenu <?php if($active=="admin"){echo "pcoded-trigger";}?>">
        <a href="javascript:void(0)">
            <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-hasmenu ">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="">
                                <a
                                    href="https://colorlib.com/polygon/adminty/files/extra-pages/email-templates/email-welcome.html">
                                    <span class="pcoded-mtext">Welcome Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a
                                    href="https://colorlib.com/polygon/adminty/files/extra-pages/email-templates/email-password.html">
                                    <span class="pcoded-mtext">Reset Password</span>
                                </a>
                            </li>
                            <li class="">
                                <a
                                    href="https://colorlib.com/polygon/adminty/files/extra-pages/email-templates/email-newsletter.html">
                                    <span class="pcoded-mtext">Newsletter Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a
                                    href="https://colorlib.com/polygon/adminty/files/extra-pages/email-templates/email-launch.html">
                                    <span class="pcoded-mtext">App Launch</span>
                                </a>
                            </li>
                            <li class="">
                                <a
                                    href="https://colorlib.com/polygon/adminty/files/extra-pages/email-templates/email-activation.html">
