                            ...
                            <div class="pcoded-inner-content">
                                ...
                                <form class="form" name="form" id="form" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10 col-sm-8">
                                            <div class="input-group">
                                              ...
                                              <input class="form-control" type="text" id="name" name="name" placeholder="Name" value="<?php echo $categories->cname; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10 col-sm-8">
                                            <!-- <div class="input-group"> -->
                                            <textarea class="form-control" id="description" name="description" placeholder="Description"><?php echo $categories->description; ?></textarea>
                                            <!-- </div> -->
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                          <?php  $returnpath = $this->config->item('category_uploaded_images_path');
                                                      ?>
                                          <img src="<?php echo $returnpath.$categories->cimage; ?>" class="round" alt="image" height="50px" width="50px">
                                        </div>
                                    </div>
