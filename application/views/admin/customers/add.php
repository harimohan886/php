                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                         ...
                                         <div class="col-lg-12 col-md-12">
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-form-label col-form-label">DOB<span class="text-danger">*</span></label>
                                                <div class="col-md-8">
                                                     <input type="text" class="form-control" placeholder="dd/mm/yyyy" name="dob_date" id="dob_date" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-lg-12 col-md-12">
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-form-label col-form-label">DOB 1<span class="text-danger">*</span></label>
                                                <div class="col-md-8">
                                                     <input type="text" class="form-control" placeholder="dd/mm/yyyy" name="future_date_1" id="future_date_1" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!--/span-->
                                     <div class="col-lg-12 col-md-12">
                                        <div class="form-group m-t-40 row">
                                            ...
                                            <div class="col-md-8">
                                                <input class='tgl tgl-ios tgl_checkbox js-switch' name="status" type='checkbox' checked="checked" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" class="btn btn-info" id="save_button">Insert</button>
