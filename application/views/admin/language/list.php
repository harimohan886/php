          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-success alert-dismissible" role="alert" id="myElem" style="display:none">
                    ...
                    <strong>Success !</strong> Language activated successfully.
                </div>
                <div class="alert alert-danger alert-dismissible" role="alert" id="myElemNo"  style="display:none">
                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <strong>Success !</strong> Language deactivated successfully. 
                </div>
                  <div class="table-responsive">
                    ...
                    <tbody>
                        <?php
                            if (count($language_records) > 0) {
                                foreach ($language_records as $category) {

                                    $edit_url = ADMIN_URL . 'language/language_edit/' . $category->id;
                                    $delete_url = ADMIN_URL . 'language/language_delete/' . $category->id;
                                    ?>  
                                    <tr>
                                        <td><?php echo $category->id; ?></td>
                                        <td><?php echo $category->code; ?></td>
                                        <td><?php echo $category->language; ?></td>
                                         <td><input type="checkbox" class="js-switch tgl_checkbox"  data-table="tbl_language" data-status="status" data-idfield="id"  data-id="<?php echo $category->id; ?>" id='cb_<?php echo $category->id; ?>'  <?php echo ($category->status == '1') ? "checked" : ""; ?> /></td>
                                        <td>
                                        <?php
