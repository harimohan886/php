...
Invoice.prototype = {
    ...
    calcTax: function (calcTax) {
       ...
       return false;
        var Tax = Number(jQuery($.opt.subtotal).html())
                       * Number(jQuery($.opt.Taxval).val()) / 100 ;
    ...
    newRow: function (products) {
        ...
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn">'+newSelection+'<a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td class="price_append"><input class="form-control price" placeholder="Price" type="text" name="price[]" id="price"> </td></tr>');
